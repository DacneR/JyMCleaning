    ...
    <div class="flex flex-col min-h-screen">
        ...
        <main class="flex-grow container mx-auto px-4 py-16 lg:px-8">
            ...
            <div class="text-center mb-16 space-y-4">
                <h1 class="text-4xl md:text-6xl font-black text-navy-900 italic uppercase inline-block border-b-8 border-orange-500 pb-2">
                    <?= ($language == 'en') ? 'Our Services' : 'Nuestros Servicios' ?>
                </h1>
                <p class="text-slate-500 text-lg md:text-xl italic font-medium">
                ...
                foreach ($services as $s): ?>
                    ...
                    <section class="flex flex-col <?= $s['side'] === 'right' ? 'md:flex-row-reverse' : 'md:flex-row' ?> items-center gap-8 md:gap-16 group">
                        ...
                        <div class="w-full md:w-1/2 space-y-6 text-center <?= $s['side'] === 'right' ? 'md:text-right' : 'md:text-left' ?>">
                            <div class="space-y-2">
                                <h2 class="text-3xl md:text-4xl font-black text-navy-900 leading-tight">
                                    <?= $s['title'] ?>
                                </h2>
                                <h3 class="text-orange-500 font-bold italic text-xl uppercase tracking-tighter">
                                    <?= $s['subtitle'] ?>
                                </h3>
                            </div>
